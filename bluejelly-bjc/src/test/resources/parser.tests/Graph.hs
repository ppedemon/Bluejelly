...
import container.array.ST (STArray, newArray, readArray, writeArray)
import container.Tree (Tree(Node), Forest)
...
data SetM s a = SetM { runSetM :: STArray s Vertex Bool -> ST s a }
