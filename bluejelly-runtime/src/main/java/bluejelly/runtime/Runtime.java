...
public class Runtime {
    ...
    private static final String VERSION = "The Bluejelly Runtime System, v";
    ...
    private static String getVersion() {
        try {
            ...
            p.load(Runtime.class.getResourceAsStream("/brt-cfg.properties"));
            return p.getProperty("brt.version");
        } catch (IOException e) {
